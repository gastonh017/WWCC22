  ...
  return(
    <>
      <Card className="my-bg-card text-dark margin_card text-center" style={{ width: '30rem'}}>
        <Card.Header className=" my-bg-card text-light " >{props.stadium}</Card.Header>
          <ListGroup variant="flush">
            ...
            <ListGroup.Item className="my-bg-card text-light strong" > Games played: {props.gamesPlayed} </ListGroup.Item>
          </ListGroup>
      </Card>
      <hr />
    </>
